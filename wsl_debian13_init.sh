...
# for transformers ModuleNotFoundError: No module named '_lzma'
sudo apt install lzma liblzma-dev libbz2-dev -y
...
wget wget https://developer.download.nvidia.com/compute/cuda/12.1.0/local_installers/cuda_12.1.0_530.30.02_linux.run
